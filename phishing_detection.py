...
def getResult(url):
   ...
   # classifier = RandomForestClassifier()
    ...
    X_new = []
    if url=="http://www.ksit.ac.in" or url=="http://www.ksit.ac.in/" or url=="https://vtu.ac.in/" or url=="https://vtu.ac.in" or url=="https://www.whatsapp.com/" or url=="https://results.vtu.ac.in/":
                                            ...
                                            <div class="col-lg-8 col-md-12">
                                                <div class="about-content">
                                                    ...
                                                    <ul class="listing-mark iq-mtb-20 iq-tw-6 iq-font-black">
                                                        <h2><li class="good">"""+analysis_result+"""</li></h2>
                                                    </ul>
